...
* Minor Update (2025). I have abandoned Nim as it is too advanced for me: compile time metaprogramming, move semantics, inheritance, "case objects" and never ending research how to fit sum types there: [2024](https://github.com/nim-lang/RFCs/issues/548), [2025](https://github.com/nim-lang/RFCs/issues/559)..., "object vs ref object", procedures which can be turned to closures with a pragma, operator and procedure overloading, hot code reloading, linear types, "proof engine", "type classes" (concepts or traits), interop with the C++ templates... See ["Nim Nuggets: Systems Programming & Metaprogramming Magic" by Aditya Siram](https://www.youtube.com/watch?v=d2VRuZo2pdA&t=15s&ab_channel=StrangeLoopConference). I prefer Odin as it is the only mature low level language which is not an oil tanker, see [Languages I considered using before Odin by Rickard Andersson](https://www.youtube.com/watch?v=vFFcCLzOOyw&t=3333s&ab_channel=RickardAndersson%28gonz%29). [Oberon+](https://oberon-lang.github.io/) also comes close, but it is not there yet. I prefer Odin's unions + function overloading + errors as values to the minimalistic OO with exceptions in Oberon+, but the latter is easily in my top 3 languages of the better C category.
